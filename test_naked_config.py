...
# Ascertain that an NASA-related section and the required keywords are present in the config file
print("Checking if config has an NASA section -->")
assert config.has_section("nasa") == True
print("OK")
...
# Ascertain that a MYSQL-related section and the required keywords are present in the config file
print("Checking if config has a MYSQL section -->")
